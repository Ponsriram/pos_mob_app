...
class OnlineItemLogsViewModel extends ChangeNotifier {
  // Outlet selection
  ...
  // Search ItemID / Name filter
  String _searchItemIdName = '';

  String get searchItemIdName => _searchItemIdName;

  void setSearchItemIdName(String value) {
    _searchItemIdName = value;
    notifyListeners();
  }
